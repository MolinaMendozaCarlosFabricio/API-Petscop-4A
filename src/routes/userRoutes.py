...
from src.controllers.userController import crear_usuario, login_usuario, obtener_usuario, get_user_by_id, edit_password_user, eliminar_usuario
...
@usuario_blueprint.route('/delete/<int:user_id>', methods=['DELETE'])
