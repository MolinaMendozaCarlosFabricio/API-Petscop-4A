...
from src.controllers.commentController import create_comment_to_local_service, create_comment_to_post, create_comment_to_response, get_comments_of_post, get_comments_of_local_service, get_comments_of_comment, edit_comment, remove_comment_of_post, remove_comment_of_local_service, remove_response_of_comment
...
@comment_blueprint.route('/comment_local_service', methods=['POST'])
def create_comment_to_local_service_route():
    data = request.get_json()
    return create_comment_to_local_service(data)
...
@comment_blueprint.route('/get_comments_of_local_service/<int:id_local>', methods=['GET'])
def get_comments_of_local_route(id_local):
    return get_comments_of_local_service(id_local)
...
@comment_blueprint.route('/remove_comment_from_local_service/<int:id_comment>', methods=['DELETE'])
def remove_comment_of_local_route(id_comment):
    return remove_comment_of_local_service(id_comment)
