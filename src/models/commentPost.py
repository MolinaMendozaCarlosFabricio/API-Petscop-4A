...
class Response_post(db.Model):
    ...
    id_post_to_comment = db.Column(db.Integer, nullable=False)
    id_comment_to_post = db.Column(db.Integer, ForeignKey(f'{schema_name}.comments.id_comment'))
    ...
    def __init__(self, id_post, id_comment):
        ...
        self.id_comment_to_post = id_comment
