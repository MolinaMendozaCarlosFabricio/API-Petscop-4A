...
class Response_local(db.Model):
    ...
    id_local_to_comment = db.Column(db.Integer, nullable=False)
    id_comment_to_local = db.Column(db.Integer, ForeignKey(f'{schema_name}.comments.id_comment'))
    ...
    def __init__(self, id_local, id_comment):
        ...
        self.id_comment_to_local = id_comment
